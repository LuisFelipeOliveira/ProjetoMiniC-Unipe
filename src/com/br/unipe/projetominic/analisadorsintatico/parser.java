...
// Wed Dec 12 23:40:56 GMT-03:00 2018
//----------------------------------------------------

package com.br.unipe.projetominic.analisadorsintatico;

import com.br.unipe.projetominic.elementos.*;

/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Dec 12 23:40:56 GMT-03:00 2018
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		IExpressao exprAtr = (IExpressao)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new DeclaracaoIDAtr ( new Identificador( id ), exprAtr ); 
...
RESULT = new java.util.ArrayList<DeclaracaoIDAtr>(); RESULT.add( DeclaracaoIDAtr );
	if( declaracoesAtrOpt != null ) { 
		...
		java.util.ArrayList<DeclaracaoIDAtr> DeclIdOpt = (java.util.ArrayList<DeclaracaoIDAtr>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new ComandoDeclIdentificadores (tipo, new Identificador(id), exprAtr, DeclIdOpt); RESULT.setEntreParenteses( false );
		...
		DeclIdOpt DeclaraOpt = (DeclIdOpt)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new ComandoAtribuicao(tipo, new Identificador(id), DeclaraOpt); RESULT.setEntreParenteses( false );
		...
		int expAtrright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		IExpressao expAtr = (IExpressao)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new ComandoExpAtribuicao ( new Identificador(id), expAtr); RESULT.setEntreParenteses( false );
              CUP$parser$result = parser.getSymbolFactory().newSymbol("Comando",13, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
  ...
  if( restoParametros != null ) { 
    ...
    RESULT.addAll( restoParametros ); 
		...
		IExpressao expressao = (IExpressao)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 RESULT = new DeclaracaoFuncao( tipo, new Identificador(id), parametros, ComOpt, expressao ); 
